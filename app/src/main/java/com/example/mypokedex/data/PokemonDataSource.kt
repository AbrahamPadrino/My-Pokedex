...
object PokemonDataSource {
    ...
    val pokemonList: List<Pokemon> = listOf(
        ...
        Pokemon(5, "Charmeleon", 58, 64, 58, 80, Pokemon.PokemonType.FIRE, "https://static.wikia.nocookie.net/minipokedex/images/3/34/5-Charmeleon.png/revision/latest?cb=20170929215817&path-prefix=es",
            R.raw.charmeleon
        ),
